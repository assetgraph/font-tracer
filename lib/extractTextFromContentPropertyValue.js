    ...
    if (token.type === 'string') {
      ...
      if (renderer) {
        ...
        for (const counterStyleName of Object.keys(
          ...
          const props = hypotheticalCounterStyleByName[counterStyleName].value;
          renderers[counterStyleName] = counteraction(
            props.system || 'decimal',
            {
              ...hypotheticalCounterStyleByName[counterStyleName].value
            }
          );
        }
        const renderer = counteraction(
          hypotheticalCounterStyleByName[token.value].value.system,
          {
